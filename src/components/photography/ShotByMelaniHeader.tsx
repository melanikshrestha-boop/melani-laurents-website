...
const nav = [
  ...
  { label: "About", href: "/photography/about" },
];
...
export function ShotByMelaniHeader({ theme = "light" }: { theme?: HeaderTheme }) {
  return (
    <header
      className={`photography-header photography-header--${theme}`}
    >
