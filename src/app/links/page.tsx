...
import { ButtonTune } from "@/components/linkree/ButtonTune";
import { YoutubeLatest } from "@/components/linkree/YoutubeLatest";

export default function LinksPage() {
  return (
    <div className="poster">
      <div className="field" aria-hidden="true">
        <img src="/links/fendi.jpg" alt="" />
        <img src="/links/spring.jpg" alt="" />
      </div>
      <div className="stage">
        ...
        <header className="head">
          <a className="identity" href="/" aria-label="Celine Nova">
            <img
              src="/eren.png"
              alt=""
              width={28}
        ...
        <nav className="buttons" aria-label="Links">
          <a href="/">
            <span className="mark">
              <img src="/eren.png" alt="" width={18} height={18} />
            </span>
            Celine Nova.
          </a>
