...
export const metadata: Metadata = {
  ...
  icons: {
    ...
    icon: [
      { url: "/eren-stay12.png?v=stay12", type: "image/png", sizes: "256x256" },
      { url: "/eren-stay12.png?v=stay12", type: "image/png", sizes: "48x48" },
      { url: "/eren-stay12.png?v=stay12", type: "image/png", sizes: "32x32" },
    ],
    apple: [
      {
        url: "/eren-stay12.png?v=stay12",
        sizes: "180x180",
        type: "image/png",
      },
    ],
    shortcut: [{ url: "/eren-stay12.png?v=stay12", type: "image/png" }],
  },
  openGraph: {
