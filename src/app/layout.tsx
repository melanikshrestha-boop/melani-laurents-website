...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      ...
      { url: "/icon.png?v=eren2", type: "image/png", sizes: "32x32" },
      { url: "/icon-192.png?v=eren2", type: "image/png", sizes: "192x192" },
    ],
    apple: [
      {
        url: "/apple-icon.png?v=eren2",
        sizes: "180x180",
        type: "image/png",
      },
    ],
    shortcut: [{ url: "/favicon.ico?v=eren2" }],
  },
  openGraph: {
