...
export const metadata: Metadata = {
  ...
  icons: {
    ...
    icon: [
      { url: "/eren-stay8.png?v=stay8", type: "image/png", sizes: "256x256" },
      { url: "/eren-stay8.png?v=stay8", type: "image/png", sizes: "32x32" },
      { url: "/eren-stay8.png?v=stay8", type: "image/png", sizes: "192x192" },
    ],
    apple: [
      {
        url: "/eren-stay8.png?v=stay8",
        sizes: "180x180",
        type: "image/png",
      },
    ],
    shortcut: [{ url: "/eren-stay8.png?v=stay8", type: "image/png" }],
  },
  openGraph: {
